...
```{r loading_required_libraries, cache = TRUE, echo = TRUE, echo = TRUE}
...
```{r reading_the_data_in_r, cache = TRUE, echo = TRUE}
...
```{r preprocessing_the_data, cache = TRUE, echo = TRUE}
...
```{r df_total_steps_per_day, cache = TRUE, echo = TRUE}
...
```{r statistics_for_total_steps_per_day, cache = TRUE, echo = TRUE}
...
```{r figure_for_total_steps_per_day, cache = TRUE, echo = TRUE, fig.path= "figure/"}
...
```{r identifying_strange_days, cache = TRUE, echo = TRUE}
...
```{r, df_details_on_strange_observations, cache = TRUE, echo = TRUE}
...
```{r df_for_average_steps_per_interval, cache = TRUE, echo = TRUE}
...
```{r interval_with_maximum_average_steps, cache = TRUE, echo = TRUE}
...
```{r figure_for_average_daily_activity_pattern, cache = TRUE, echo = TRUE, fig.path= "figure/"}
...
```{r total_number_of_missing_data, cache = TRUE, echo = TRUE}
...
```{r length_of_gaps_of_missing_data, cache = TRUE, echo = TRUE}
...
```{r missing_data_per_date, cache = TRUE, echo = TRUE}
...
```{r imputing_missing_data, cache = TRUE, echo = TRUE}
...
```{r df_with_imputed_values_for_total_steps_per_day, cache = TRUE, echo = TRUE}
...
```{r figure_for_total_steps_per_day_imputed, cache = TRUE, echo = TRUE,  fig.path= "figure/"}
...
```{r effects_on_imputation_on_variation, cache = TRUE, echo = TRUE}
...
```{r df_for_average_daily_activity_plus_wday, cache = TRUE, echo = TRUE}
...
```{r figure_for_average_daily_activity_pattern_over_wday, cache = TRUE, echo = TRUE,  fig.path= "figure/"}
...
```{r session_info, cache = TRUE, echo = TRUE}
